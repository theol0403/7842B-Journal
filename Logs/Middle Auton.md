...
This will be our secondary auton. It will allow us score up to 6 points. It will only be run when our alliance partner is unable to run auton. Here is the code:
